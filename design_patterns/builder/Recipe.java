...
public class Recipe {
	...
	public Recipe(int mozarellaCheeseAmount, int fetaCheeseAmount, int mushroomsAmount, int pineappleAmount) {
	...
	public String toString() {
		return "Recipe [mozarellaCheeseAmount=" + mozarellaCheeseAmount + ", fetaCheeseAmount=" + fetaCheeseAmount
